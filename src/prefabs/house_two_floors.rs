use crate::{constants::{HOUSE_INTERIOR_COLUMNS, HOUSE_INTERIOR_ROWS}, entities::{known_species::{SPECIES_SEAT_GREEN, SPECIES_STAIRS_DOWN, SPECIES_STAIRS_UP, SPECIES_TABLE, SPECIES_TELEPORTER}, species::{self, make_entity_by_species, Species, SpeciesConvertible}}, game_engine::{entity::Entity, world::World}, maps::{biome_tiles::Biome, constructions_tiles::Construction}, utils::ids::get_next_id};
