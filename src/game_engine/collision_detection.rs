...
#[cfg(test)]
mod tests {
        use crate::{constants::RECT_ORIGIN_SQUARE_100, entities::{building::{Building, BuildingType}, hero::Hero}, game_engine::{entity::Entity, entity_body::EmbodiedEntity, visible_entities::compute_visible_entities, world::World}, worlds::constants::WORLD_ID_DEMO, utils::vector::Vector2d};
