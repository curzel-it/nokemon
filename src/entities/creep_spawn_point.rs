...
impl_embodied_entity!(CreepSpawnPoints);
impl_animated_entity!(CreepSpawnPoints);

impl Entity for CreepSpawnPoints {
...
impl EntityFactory {
    pub fn build_creep_spawn_point(&self) -> CreepSpawnPoints {
        CreepSpawnPoints::new(self.build("creepspawnpoint"))
    }
}
