use crate::{constants::{BASE_ENTITY_SPEED, TILE_SIZE}, game_engine::{concrete_entity::ConcreteEntity, entity::Entity, entity_body::EntityBody, world::World}, utils::{directions::Direction, rect::Rect, vector::Vector2d}};
