...
fn main() {
    ...
    initialize_config_strings(
        "en".to_owned(),
        "data".to_owned(),
        "data/species.json".to_owned(),
        "data/inventory.json".to_owned(),
        "data/save.json".to_owned(),
        "lang".to_owned()
    );
